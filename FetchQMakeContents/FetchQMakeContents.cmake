function(Core_Utility_FetchQMakeContents)
  ...
  if(NOT FQC_OUTPUT_SOURCE_DIRECTORY)
    set(FQC_OUTPUT_SOURCE_DIRECTORY ${default_prefix_path}/source)
  endif()

  if(NOT FQC_OUTPUT_BUILD_DIRECTORY)
    set(FQC_OUTPUT_BUILD_DIRECTORY ${default_prefix_path}/build)
  endif()

  if(NOT FQC_OUTPUT_INSTALL_DIRECTORY)
    set(FQC_OUTPUT_INSTALL_DIRECTORY ${default_prefix_path}/install)
  endif()
  ...
  file(MAKE_DIRECTORY ${FQC_OUTPUT_BUILD_DIRECTORY})
  file(MAKE_DIRECTORY ${FQC_OUTPUT_INSTALL_DIRECTORY})

  Core_Utility_CloneRepository(
    GIT_REPOSITORY ${FQC_GIT_REPOSITORY}
    GIT_TAG ${FQC_GIT_TAG}
    OUTPUT_DIRECTORY ${FQC_OUTPUT_SOURCE_DIRECTORY}
  ...
  if(FQC_QMAKE_CONFIG_DIRECTORY)
    set(FQC_OUTPUT_SOURCE_DIRECTORY ${FQC_OUTPUT_SOURCE_DIRECTORY}/${FQC_QMAKE_CONFIG_DIRECTORY})
  endif()

  if(${FQC_RUN_BUILD_RULE})
    Core_Details_FetchQMakeContents_ConfigureQMake(
      ${FQC_OUTPUT_SOURCE_DIRECTORY} "${FQC_QMAKE_ARGUMENTS}" ${FQC_OUTPUT_BUILD_DIRECTORY})
    Core_Details_FetchQMakeContents_BuildQMake(${FQC_OUTPUT_BUILD_DIRECTORY})
  endif()

  if(FQC_RUN_INSTALL_RULE)
    if(${FQC_RUN_INSTALL_RULE})
      Core_Details_FetchQMakeContents_InstallQMake(${FQC_OUTPUT_BUILD_DIRECTORY})
    endif()
  endif()
